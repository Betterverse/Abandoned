...
public class MDEntityListener extends EntityListener{
    ...
    public void onEntityTarget(EntityTargetEvent event) {
        if(event.getTarget() instanceof Player) {
            ...
            if(MobDisguise.disList.contains(p.getName()) && MobDisguise.cfg.getBoolean("MobTarget.enabled", true)) {
    ...
    public void onEntityDeath(final EntityDeathEvent event) {
        if(event.getEntity() instanceof Player) {
            ...
            if(MobDisguise.cfg.getBoolean("RealDrops.enabled", false) && MobDisguise.disList.contains(p.getName())) {
