...
public class TownsWorld extends TownsObject {
	private List<Town> towns = new ArrayList<Town>();
	private boolean isClaimable = true, isPVP, isForcePVP, isForceExpl, isForceFire, isForceTownMobs, hasWorldMobs, isDisablePlayerTrample, isDisableCreatureTrample, isUsingTowns = true, isUsingPlotManagementDelete = true, isUsingPlotManagementMayorDelete = true, isUsingPlotManagementRevert = true, isUsingPlotManagementWildRevert = true;
	...
	public TownsWorld(String name) {
		setName(name);

		isPVP = true;
		isForcePVP = TownsSettings.isForcingPvP();
		isForceFire = TownsSettings.isForcingFire();
		isForceTownMobs = TownsSettings.isForcingMonsters();
		isDisablePlayerTrample = TownsSettings.isPlayerTramplingCropsDisabled();
		isDisableCreatureTrample = TownsSettings.isCreatureTramplingCropsDisabled();
		hasWorldMobs = true;
		//hasWorldMobs = TownsSettings.isWorldMonstersOn(); ??
		isForceExpl = TownsSettings.isForcingExplosions();
		setUsingPlotManagementDelete(TownsSettings.isUsingPlotManagementDelete());
		setUsingPlotManagementRevert(TownsSettings.isUsingPlotManagementRevert());
		setPlotManagementRevertSpeed(TownsSettings.getPlotManagementSpeed());
		setUsingPlotManagementWildRevert(TownsSettings.isUsingPlotManagementWildRegen());
		setPlotManagementWildRevertDelay(TownsSettings.getPlotManagementWildRegenDelay());
	}
	...
	public List<Integer> getPlotManagementDeleteIds() {
		if (plotManagementDeleteIds == null) {
			return TownsSettings.getPlotManagementDeleteIds();
		} else {
	...
	public List<String> getPlotManagementMayorDelete() {
		if (plotManagementMayorDelete == null) {
			return TownsSettings.getPlotManagementMayorDelete();
		} else {
	...
	public List<Integer> getPlotManagementIgnoreIds() {
		if (plotManagementIgnoreIds == null) {
			return TownsSettings.getPlotManagementIgnoreIds();
		} else {
	...
	/**
	 * @param isUsingPlotManagementWildRevert
	...
	public List<Integer> getUnclaimedZoneIgnoreIds() {
		if (unclaimedZoneIgnoreIds == null) {
			return TownsSettings.getUnclaimedZoneIgnoreIds();
		} else {
	...
	public Boolean getUnclaimedZoneBuild() {
		if (unclaimedZoneBuild == null) {
			return TownsSettings.getUnclaimedZoneBuildRights();
		} else {
	...
	public Boolean getUnclaimedZoneDestroy() {
		if (unclaimedZoneDestroy == null) {
			return TownsSettings.getUnclaimedZoneDestroyRights();
		} else {
	...
	public Boolean getUnclaimedZoneSwitch() {
		if (unclaimedZoneSwitch == null) {
			return TownsSettings.getUnclaimedZoneSwitchRights();
		} else {
	...
	public String getUnclaimedZoneName() {
		if (unclaimedZoneName == null) {
			return TownsSettings.getUnclaimedZoneName();
		} else {
	...
	public void setUsingTowns(boolean isUsingTowns) {
		this.isUsingTowns = isUsingTowns;
	}

	public boolean isUsingTowns() {
		return isUsingTowns;
	}
	...
	public Boolean getUnclaimedZoneItemUse() {
		if (unclaimedZoneItemUse == null) {
			return TownsSettings.getUnclaimedZoneItemUseRights();
		} else {
