...
public class SimpleNPCManager extends GenericFlaggableManager<NPC> implements NPCManager {
    ...
    private com.topcat.npclib.NPCManager handle;
    ...
    void load(PersonasPlugin plugin) {
        handle = new com.topcat.npclib.NPCManager(plugin);
    }
    ...
    public void spawnNPC(NPC npc, Location location) {
        ...
        NPCEntity handel = (NPCEntity) handle.spawnHumanNPC(npc.getName(), event.getLocation(), npc.getId()).getEntity();
